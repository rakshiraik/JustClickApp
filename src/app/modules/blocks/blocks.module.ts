...
import { BlockCategoriesHeaderComponent } from './block-categories-header/block-categories-header.component';
...
import { BlockProductsHeaderComponent } from './block-products-header/block-products-header.component';
...
@NgModule({
    declarations: [
        ...
        BlockCategoriesHeaderComponent,
