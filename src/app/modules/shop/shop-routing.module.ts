...
import { PageCustomerRegistrationComponent } from './pages/page-customerRegistration/page-customerRegistration.component';
import { PageProductRegistrationComponent } from './pages/page-productRegistration/page-productRegistration.component';
import { PageCategoryRegistrationComponent } from './pages/page-categoryRegistration/page-categoryRegistration.component';
...
const routes: Routes = [
    ...
    // },
    {
        path: 'cart/customerRegistration',
        component: PageCustomerRegistrationComponent,
        //canActivate: [CheckoutGuard],
    },    
    {
        path: 'cart/productRegistration',
        component: PageProductRegistrationComponent,
        //canActivate: [CheckoutGuard],
    },
    {
        path: 'cart/categoryRegistration',
        component: PageCategoryRegistrationComponent,
    },
    {
