...
export class ShopService {
    ...
    getCategoriesAddProduct(options?: IRequestOptions): Observable<any[]> {
        /**
         * This is what your API endpoint might look like:
         *
         * https://example.com/api/shop/categories.json?parent=latest-news&depth=1
        ...
        const headers = new HttpHeaders();
        const params = new HttpParams();
         return this.http.get<any[]>(this.url+'/Category', options);
        //return this.http.get<any[]>('http://localhost:11055/api/Bill/GetCategories', options);
     ...
     * @param depth - Maximum depth of category tree.
     */
    getPopularCategories(options?: IRequestOptions): Observable<any[]> {
        /**
         * This is what your API endpoint might look like:
         *
         * https://example.com/api/shop/categories.json?slugs=power-tools,measurement&depth=1
        ...
        const headers = new HttpHeaders();
        const params = new HttpParams();
        return this.http.get<any[]>(this.url+'/api/Category', options);
